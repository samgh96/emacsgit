...
(let ((mainbg (when (display-graphic-p) "#222222")));; "default")))
  (custom-theme-set-faces
   ...
   '(mode-line ((t (:foreground "#0022ff" :bold t :background "#043C02"
   ...
   '(powerline-active2 ((t (:foreground "#ffffff" :background "#043C02"))))
   '(powerline-inactive1 ((t (:foreground "#ffffff" :background "#555555"))))
   '(powerline-inactive2 ((t (:foreground "#ffffff" :background "#124664"))))
   ...
   '(tool-tips ((t (:inherit 'variable-pitch :foreground "black" :background "#043C02"))))
   '(tooltip ((t (:inherit 'variable-pitch :foreground "black" :background "#043C02"))))
   ...
   '(diff-index ((t (:foreground "#043C02" :bold t))))
   '(diff-file-header ((t (:foreground "#aaaaaa" :bold t))))
   '(diff-hunk-header ((t (:foreground "#043C02"))))
   ...
   '(gnus-summary-cancelled ((t (:background "#222222" :foreground "#043C02"))))
   ...
   '(magit-diff-hunk-heading-highlight ((t (:foreground "#043C02"))))
   ...
   '(helm-selection ((t (:foreground "#ff0099" :italic t :bold t :background "#613DAD"))))
   '(helm-match ((t (:foreground "#3733FF"))))
   '(helm-visible-mark ((t (:background "#393300" :foreground "#ff0099" :bold nil :italic nil))))
...
(set-face-background 'minibuffer-prompt "darkgreen")
