...
(custom-set-faces
 ...
 '(nlinum-current-line ((t (:inherit hl-line :foreground "#f2f2f3" :strike-through nil :underline nil :slant normal :weight normal))))
 '(spaceline-evil-normal ((t (:background "DarkGreen" :foreground "#3E3D31" :inherit (quote mode-line)))))
 '(spaceline-evil-visual ((t (:background "white" :foreground "black" :inherit (quote mode-line)))))
 '(spaceline-highlight-face ((t (:background "#ff5d38" :foreground "white" :inherit (quote mode-line)))))
 '(spaceline-unmodified ((t (:background "#ff5d38" :foreground "white" :inherit (quote mode-line))))))
